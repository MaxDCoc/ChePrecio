...
export class  $npmConfigName1782255749079 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."scans_verdict_enum" AS ENUM('cheap', 'normal', 'expensive')`);
        ...
        await queryRunner.query(`CREATE TABLE "sepa_prices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "barcode" character varying, "name" character varying NOT NULL, "brand" character varying, "store_chain" character varying NOT NULL, "province" character varying NOT NULL, "price_cents" integer NOT NULL, "price_date" date NOT NULL, CONSTRAINT "PK_d6f7333fbacd011e5333b0b9f58" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_1ed2e0496cd96bedff7c464d07" ON "sepa_prices"  ("barcode", "province") `);
        await queryRunner.query(`ALTER TABLE "scans" ADD CONSTRAINT "FK_b1d041293c86a1bfbd15c559385" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "scans" ADD CONSTRAINT "FK_69640b09dc5ad9d57d3e3617086" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "scans" DROP CONSTRAINT "FK_69640b09dc5ad9d57d3e3617086"`);
        await queryRunner.query(`ALTER TABLE "scans" DROP CONSTRAINT "FK_b1d041293c86a1bfbd15c559385"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1ed2e0496cd96bedff7c464d07"`);
